...
def payment(request):
    ...
    # API_key = 'eexpr5ef637e34be94@ssl'
    # store_id = 'eexpr5ef637e34be94'
    ...
    # address=saved_address.address, city=saved_address.city, postcode=saved_address.zipcode, country=saved_address.country)
    # response_data = mypayment.init_payment()

    # redirect(response_data['GatewayPageURL'])
