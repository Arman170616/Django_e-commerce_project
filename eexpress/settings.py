"""
Django settings for eexpress project.
...
SECRET_KEY = 'w0rt12xrkn(=d#a)j_laj)#fcu)jhhr0*41%2ivme@ba%u+hm='
...
WSGI_APPLICATION = 'eexpress.wsgi.application'
